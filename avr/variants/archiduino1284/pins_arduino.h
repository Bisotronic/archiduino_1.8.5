...
static const uint8_t M1A = PB6;
static const uint8_t M1B = PB5;
static const uint8_t M1C = PB7;
static const uint8_t M1D = PB4;
static const uint8_t M2A = PD3;
static const uint8_t M2B = PD2;
static const uint8_t M2C = PD5;
static const uint8_t M3A = PD1;
static const uint8_t M3B = PD0;
static const uint8_t M3C = PA6;
static const uint8_t M4A = PB3;
static const uint8_t M4B = PB2;
static const uint8_t M5A = PD4;
static const uint8_t M5B = PD5;
static const uint8_t M6A = PC0;
static const uint8_t M6B = PC1;
...
static const uint8_t M10A = PA7;
static const uint8_t M10B = PA6;
static const uint8_t M11A = PC7;
static const uint8_t M11B = PC6;
static const uint8_t M12A = PB0;
static const uint8_t M12B = PB1;

static const uint8_t AN_M7A = PD3;
static const uint8_t AN_M7B = PD2;
static const uint8_t AN_M8A = PB1;
static const uint8_t AN_M8B = PB0;
static const uint8_t AN_M9A = PB3;
static const uint8_t AN_M9B = PB2;
static const uint8_t AN_M10A = PD1;
static const uint8_t AN_M10B = PD0;
...
static const uint8_t LCD_BKLIGHT 	= PD5; // backward compatibility with Archiduino 32U4
